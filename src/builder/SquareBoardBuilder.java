...
public class SquareBoardBuilder implements BoardBuilder {
    ...
    private void createNodes() {
        ...
        add("B0", 4, 2); add("B1", 5, 1); add("B2", 6, 0);
        add("C0", 2, 2); add("C1", 1, 1); add("C2", 0, 0);
        add("D0", 2, 4); add("D1", 1, 5); add("D2", 0, 6);
    ...
    private void connectNodes() {
        ...
        connect("N3", "B2"); connect("B2", "B1"); connect("B1", "B0"); connect("B0", "OO");
        connect("N7", "C2"); connect("C2", "C1"); connect("C1", "C0"); connect("C0", "OO");
        connect("OO", "A0"); connect("A0", "A1"); connect("A1", "A2");

        connect("OO", "B0"); connect("OO", "C0"); connect("OO", "D0");
        connect("D0", "D1"); connect("D1", "D2"); connect("D2", "N12");
    }
