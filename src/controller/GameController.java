...
public class GameController {
    ...
    public GameController(DiceManager diceManager, GameManager gameManager, GameUIBase gameUIBase) {
        this.diceManager = diceManager;
        this.gameManager = gameManager;
        this.gameUIBase = gameUIBase;

        // 윷 던지기 버튼 클릭 시 이벤트 처리
        gameUIBase.setRollListener(this::handleDiceRoll);
    }
    ...
    public void handleDiceRoll() {
        ...
        if (gameUIBase.isRandomMode()) {
            ...
            try {
                // 수동 입력값 받아 반환
                int input = Integer.parseInt(gameUIBase.getManualInput());
        ...
        gameUIBase.showDiceResult(results); // Dice Panel에 결과 표시
